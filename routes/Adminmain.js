            ...
            success: function (data) {
                ...
                $.map(data, function (value) {
                    allsongs = allsongs + '<tr>' + '<td>' +
                        ...
                        value.moviename + '</td><td ><button  data-attr="' + value._id + '" class="delete">delete</button></td>' +
                        '<td><button  data-attr="' + value.songname + '" class="insert">InsertSong</button></td></tr>';
                });
                ...
                $(".delete").on('click', function () {
                    ...
                    $(this).parent().parent().hide()
                    // myarray.push(deletedid);
                })

                $('.insert').on('click', function () {
                    var insertsongname = $(this).attr('data-attr')
                    // myarray.push({"mydata":insertsongname});
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            $(".addsongplaylist").on('click', function () {
                                ...
                                // alert("data moved to function..!");
                                myfunction(addid,insertsongname);
                            })
...
// console.log("insertsongname")
// console.log(myarray)

                function myfunction(myid,mysong) {
                    // alert(myid);
                    // alert(mysong);
                    // myarray.push(mysong);
                    // alert(myarray)
                    ...
                    $.ajax({
                        method: "post",
                        url: 'http://localhost:5000/playlist/addthis',
                        headers: {
                            token: admintoken
                        },
